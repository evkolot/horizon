...
urlpatterns = patterns('',
    ...
    url(r'^(?P<application_id>[^/]+)/edit/delete_image/$',
    ...
    url(r'^(?P<application_id>[^/]+)/edit/roles/$', 
    ...
    url(r'^(?P<application_id>[^/]+)/step/roles/$', 
        views.RolesView.as_view(
            template_name='idm/myApplications/roles/_workflow_step.html'), 
        name='roles_step'),
    url(r'^(?P<application_id>[^/]+)/$', 
        views.DetailApplicationView.as_view(), name='detail'),
    url(r'^(?P<application_id>[^/]+)/edit/users/$', 
